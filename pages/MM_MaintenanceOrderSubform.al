page 50106 "MM Maintenance Order Subform"
{
    ApplicationArea = All;
    Caption = 'Maintenance Order Subform';
    PageType = ListPart;
    SourceTable = "MM Maintenance Line";
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                {
                    ToolTip = 'Specifies the value of the Work Hours field.', Comment = '%';
                }
            }
        }
    }
